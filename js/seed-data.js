...
export const SEED_GARMENTS = [
  ...
  { name: 'Anzughose Grau', category: 'bottom', subtype: 'Anzughose',
    color: '#8C8C88', pattern: 'solid', patternColor: null, formality: 3, warmth: 2 },
  { name: 'Faltenrock Tartan', category: 'bottom', subtype: 'Faltenrock',
    color: '#7A2E2E', pattern: 'tartan', patternColor: '#22334E', formality: 2, warmth: 2 },
  { name: 'Tennisrock Weiß', category: 'bottom', subtype: 'Tennisrock',
    color: '#FAFAF7', pattern: 'solid', patternColor: null, formality: 1, warmth: 1 },

  { name: 'Hemdblusenkleid Denim', category: 'dress', subtype: 'Hemdblusenkleid',
    color: '#3E5573', pattern: 'solid', patternColor: null, formality: 2, warmth: 2 },
  ...
  { name: 'Weiße Sneaker', category: 'shoes', subtype: 'Weiße Sneaker',
    color: '#FAFAF7', pattern: 'solid', patternColor: null, formality: 1, warmth: 1 },
  { name: 'Ballerinas Navy', category: 'shoes', subtype: 'Ballerinas',
    color: '#22334E', pattern: 'solid', patternColor: null, formality: 2, warmth: 1 },

  { name: 'Seidentuch Senf', category: 'accessory', subtype: 'Seidentuch',
  ...
  { name: 'Perlenkette', category: 'accessory', subtype: 'Perlenkette',
    color: '#F2E9DC', pattern: 'solid', patternColor: null, formality: 3, warmth: 1 },
